...
angular
  ...
  .run(['$rootScope', function($rootScope){
    $rootScope.layoutCollapsed = true;
    // Restore layout settings
    if( angular.isUndefined(localStorage.getItem('layoutCollapsed')) || localStorage.getItem('layoutCollapsed') === null ){
      localStorage.setItem('layoutCollapsed', $rootScope.layoutCollapsed);
    }
    else{
      $rootScope.layoutCollapsed = localStorage.getItem('layoutCollapsed');
    }
    $rootScope.$watch('layoutCollapsed', function () {
      localStorage.setItem('layoutCollapsed', $rootScope.layoutCollapsed);
    }, true);
  }])
